...
:::note
The AI-assisted features require an AI provider to be configured on your
instance (OpenAI, Anthropic, or a local ollama model) — see
[AI features](/docs/oss/self-deployment#ai-features). Without one, issue
creation works normally with manually entered titles and metadata.
:::
