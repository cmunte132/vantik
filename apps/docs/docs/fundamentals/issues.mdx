...
:::note
The AI-assisted features require an OpenAI-compatible endpoint to be
configured on your instance — hosted or local — see
[AI features](/docs/oss/self-deployment#ai-features). Without one they are
hidden rather than shown and broken, and issue creation works normally with
manually entered titles and metadata.
:::
