...
A Trigger can be an event from an integration (e.g., Slack, Discord, GitHub, Zendesk) or a Vantik-specific event (e.g., a comment on an issue, assigning or labeling an issue). 
